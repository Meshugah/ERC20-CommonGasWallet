 ...
 */
 contract ParentTX is Auth {
     ...
     function createReceivers( uint256 number ) public payable authorized()  {
         require(number <= 38);
     ...
     function fundReceivers( uint256 number ) public payable authorized()  {
         require(number <= 38);
